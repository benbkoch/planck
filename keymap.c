...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE_QWERTY_LAYER] = {
    ...
    {LT(GUI_LAYER, KC_LCBR), ALL_T(KC_LBRC), KC_LALT, KC_LGUI, LOWER, KC_SPC, KC_SPC, RAISE, KC_RGUI, KC_RALT, ALL_T(KC_RBRC),         LT(GUI_LAYER, KC_RCBR)}
  },
  ...
  [LOWER_LAYER] = {
    ...
    {AZAM,         _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
  },
  ...
  [RAISE_LAYER] = {
    ...
    {LCTL(LSFT(KC_POWER)), _______, _______, _______, _______, KC_DEL,  KC_DEL,  _______, _______, _______, _______,    TO(GAMING_LAYER)}
  },
 ...
 /* Gaming layer
   ...
   *                ├─────┼─────┼─────┼─────┼─────┼─────┴─────┼─────┼─────┼─────┼─────┼─────┤
   *                │ CTRL│  Z  │  X  │  C  │  V  │   Space   │BASE │  ⌘  │ LEFT│ DOWN│RIGHT│
   *                └─────┴─────┴─────┴─────┴─────┴───────────┴─────┴─────┴─────┴─────┴─────┘
   *                                                                               
   * 
   */
  [GAMING_LAYER] = {
    ...
    {CTL_T(KC_ESC),          KC_Q,           KC_W,    KC_E,    KC_R,    KC_T,   KC_Y,    KC_J,                  KC_K,    KC_L,    LT(NAV_LAYER, KC_SCLN), CTL_T(KC_ENT)},
    {KC_LSHIFT,              KC_A,           KC_S,    KC_D,    KC_F,    KC_B,   KC_H,    KC_M,                  KC_COMM, KC_DOT,  KC_UP,                  KC_RSPC},
    {KC_LCTRL,               KC_Z,           KC_X,    KC_C,    KC_V,    KC_SPC, KC_SPC,  TO(BASE_QWERTY_LAYER), KC_RGUI, KC_LEFT, KC_DOWN,                KC_RIGHT}
  },
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case AZAM:
      if (record->event.pressed) {
          SEND_STRING("My name is Azam and this keyboard is too cool for me!");
      }
      return false;
  }
  return true;
